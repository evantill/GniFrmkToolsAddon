...
public class Configuration {
    ...
    public String toString() {
        return Objects.toStringHelper(this).add("name", getName()).add("creation", getCreation()).add("modification", getModification()).add("adapterConnectionList", getAdapterConnectionList()).add("adapterNotificationList", getAdapterNotificationList()).add("adapterListenerList", getAdapterListenerList()).add("portList", getPortList()).add("schedulerList", getSchedulerList()).add("jmsTriggerList", getJmsTriggerList()).add("nativeTriggerList", getNativeTriggerList()).add("jmsAliasList", getJmsAliasList()).toString();
    }
