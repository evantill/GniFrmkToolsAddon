 ...
 */
@XmlType
public class AdapterListener extends Component<AdapterListenerInfo, ActivableComponentState> {
     ...
     */
    @Override
    public <T extends Component<AdapterListenerInfo, ActivableComponentState>> int compareStatusTo(T that) {
