 ...
 * @author: e03229
 */
public abstract class AbstractInvokeHandler2<A extends Action<R>, R extends Result>
        implements InvokeHandler<A, R> {
    protected static final IData EMPTY_INPUT = IDataFactory.create();

    protected final NSName service;

    public AbstractInvokeHandler2(String serviceName) {service = NSName.create(serviceName);}
