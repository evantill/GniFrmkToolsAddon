...
public class ConfigurationComposantType1
        extends BaseComponentConfiguration<Component1Type, Component1, Component1Id, Component1State> {

    public ConfigurationComposantType1(Builder<Component1Type, Component1, Component1Id, Component1State> builder) {
        super(builder);
    }
